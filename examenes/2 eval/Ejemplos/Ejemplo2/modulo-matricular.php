    ...
    ?>
        <div>
            <form action="#" method="post">
                DNI: <input name="dni" value="<?php echo $dni;?>" type="text" required /> <br><br>
                COD CURSO: <input name="dni" type="text" required /> <br><br>
                PRUEBA A: <input name="dni" type="text" required /> <br><br>
                PRUEBA B: <input name="dni" type="text" required /> <br><br>
                TIPO: <input name="dni" type="text" required /> <br><br>
                INSCRIPCION: <input name="dni" type="text" required /> <br><br>
